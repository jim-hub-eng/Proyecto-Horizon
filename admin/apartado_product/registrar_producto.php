<?php
    ...
    $consulta = "INSERT INTO productos(imagen, nombre, descripcion, precio, descuento, categoria)
                VALUES('$imagen', '$nombre_articulo', '$des_articulo', '$precio_articulo', '$descuento_articulo','$categoria')";
